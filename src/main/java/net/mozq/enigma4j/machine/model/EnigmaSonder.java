 ...
 */
public class EnigmaSonder extends EnigmaMachineModel {
	...
	/** Rotor I */
	public static final Rotor I = new Rotor("I", LETTERS, "VEOSIRZUJDQCKGWYPNXAFLTHMB", "Q");
	
	/** Rotor II */
	public static final Rotor II = new Rotor("II", LETTERS, "UEMOATQLSHPKCYFWJZBGVXINDR", "E");
	
	/** Rotor III */
	public static final Rotor III = new Rotor("III", LETTERS, "TZHXMBSIPNURJFDKEQVCWGLAOY", "V");
	
	/** UKW */
	public static final Reflector UKW = new Reflector("UKW", LETTERS, "CIAGSNDRBYTPZFULVHEKOQXWJM");

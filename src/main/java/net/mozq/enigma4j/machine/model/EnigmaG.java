 ...
 */
public class EnigmaG extends EnigmaMachineModel {
	...
	/** Rotor I */
	public static final Rotor I = new Rotor("I", LETTERS, "LPGSZMHAEOQKVXRFYBUTNICJDW", "SUVWZABCEFGIKLOPQ");
	
	/** Rotor II */
	public static final Rotor II = new Rotor("II", LETTERS, "SLVGBTFXJQOHEWIRZYAMKPCNDU", "STVYZACDFGHKMNQ");
	
	/** Rotor III */
	public static final Rotor III = new Rotor("III", LETTERS, "CJGDPSHKTURAWZXFMYNQOBVLIE", "UWXAEFHKMNR");

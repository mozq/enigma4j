 ...
 */
public class EnigmaSpanish_S extends EnigmaMachineModel {
	...
	/** Rotor I */
	public static final Rotor I = new Rotor("I", LETTERS, "OCHQZMJPFIWEXTYLGVBKDNURAS", "Q");
	
	/** Rotor II */
	public static final Rotor II = new Rotor("II", LETTERS, "HWBEOSZFQMTXRKIGVJYPUCLNAD", "E");
	
	/** Rotor III */
	public static final Rotor III = new Rotor("III", LETTERS, "XTKFJRMLGYVQWUBIEHANPDSOZC", "V");
	
	/** Rotor IV */
	public static final Rotor IV = new Rotor("IV", LETTERS, "IGTCNQWJMHXFEZVSYBLPROKDAU", "J");
	
	/** Rotor V */
	public static final Rotor V = new Rotor("V", LETTERS, "NXEKUZMQLVCTIRJYHSDGAFBPWO", "Z");
	
	/** UKW */
	public static final Reflector UKW = new Reflector("UKW", LETTERS, "YIOGTXDKBSHVWRCQPNJEZLMFAU");

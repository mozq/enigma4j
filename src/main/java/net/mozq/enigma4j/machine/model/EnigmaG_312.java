 ...
 * G31 Abwehr Enigma
 */
public class EnigmaG_312 extends EnigmaMachineModel {
	...
	/** Rotor I */
	public static final Rotor I = new Rotor("I", LETTERS, "DMTWSILRUYQNKFEJCAZBPGXOHV", "SUVWZABCEFGIKLOPQ");
	
	/** Rotor II */
	public static final Rotor II = new Rotor("II", LETTERS, "HQZGPJTMOBLNCIFDYAWVEUSRKX", "STVYZACDFGHKMNQ");
	
	/** Rotor III */
	public static final Rotor III = new Rotor("III", LETTERS, "UQNTLSZFMREHDPXKIBVYGJCWOA", "UWXAEFHKMNR");
	
	/** UKW */
	public static final Reflector UKW = new Reflector("UKW", LETTERS, "RULQMZJSYGOCETKWDAHNBXPVIF", "");

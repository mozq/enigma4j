 ...
 */
public class EnigmaSpanish_F extends EnigmaMachineModel {
	...
	/** Rotor I */
	public static final Rotor I = new Rotor("I", LETTERS, "HFOTWPDURMCGXJLQEIVZSKBNAY", "Y");
	
	/** Rotor II */
	public static final Rotor II = new Rotor("II", LETTERS, "MUHTASIPJYNCVKLOXFDZEGQBWR", "E");
	
	/** Rotor III */
	public static final Rotor III = new Rotor("III", LETTERS, "DKWOJVUNGLFTZCSYIBEARHXQPM", "N");

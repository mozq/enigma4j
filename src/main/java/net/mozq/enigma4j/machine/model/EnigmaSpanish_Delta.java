 ...
 */
public class EnigmaSpanish_Delta extends EnigmaMachineModel {
	...
	/** Rotor I */
	public static final Rotor I = new Rotor("I", LETTERS, "CVFWJOBXANQTDZUMEYRPSKGILH", "Q");
	
	/** Rotor II */
	public static final Rotor II = new Rotor("II", LETTERS, "XJGURHZMYDLATWKSEPNCQFOIBV", "E");
	
	/** Rotor III */
	public static final Rotor III = new Rotor("III", LETTERS, "SYIGXELDUKBVOAWTZHQNFCRMJP", "V");
	
	/** Rotor IV */
	public static final Rotor IV = new Rotor("IV", LETTERS, "HKTZDSRFWPCQJIYXNVMUGELAOB", "J");
	
	/** Rotor V */
	public static final Rotor V = new Rotor("V", LETTERS, "WMGRKEJUAZFTOXINDYBQVHLCPS", "Z");
	
	/** UKW */
	public static final Reflector UKW = new Reflector("UKW", LETTERS, "DONAJUXTQELKSCBZIVMHFRYGWP");
